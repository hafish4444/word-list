...
export function QuizControls({
  ...
  if (!isAnswerShown && timer > 0) {
    // During countdown (30-1 seconds) - show only Undo and Show Answer
    return (
  ...
  // When answer is shown (either manually or timer hit 0) - show Fail/Pass buttons
  if (isLastQuestion) {
